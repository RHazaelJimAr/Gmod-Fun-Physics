SWEP.PrintName = "Horizontal Throw" -- This will be shown in the spawn menu, and in the weapon selection menu
SWEP.Author = "Randy" -- These two options will be shown when you have the weapon highlighted in the weapon selection menu
SWEP.Instructions = "Left mouse to apply 100N of horizontal force to an object, right click for -100N"
...
function SWEP:PrimaryAttack()
    ...
    self:HorizontalForce(Vector(100,0,0))
end
...
function SWEP:HorizontalForce(force)
