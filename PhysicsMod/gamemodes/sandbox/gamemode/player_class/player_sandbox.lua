...
function PLAYER:Loadout()
	...
	if ( cvars.Bool( "sbox_weapons", true ) ) then
		...
		self.Player:Give( "weapon_bathbomber" )
		self.Player:Give( "weapon_vacuumgun" )
		self.Player:Give( "weapon_masschanger" )
		self.Player:Give( "weapon_horizontalthrow" )
		self.Player:Give( "weapon_verticalthrow" )
